...
class AppColors {
  ...
  // 🌟🌟 إضافة ألوان التدرج (الجراديانت) المطلوبة لـ TitleSubtitleCell
...
// =========================================================================
// 2. كود TitleSubtitleCell (معدّل ليناسب الثيم الداكن)
// =========================================================================
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          // 🌟 استخدام لون الخلفية الداكن للبطاقات
          color: AppColors.cardBackgroundColor,
          borderRadius: BorderRadius.circular(15),
          boxShadow: [
              // تعديل الظل ليتناسب مع الخلفية الداكنة
              BoxShadow(
        ...
        children: [
          ShaderMask(
            ...
            shaderCallback: (bounds) {
              return LinearGradient(
                  colors: AppColors.primaryG, // استخدام التدرج المعرّف
            ...
            child: Text(
              title,
              style: TextStyle(
                  // اللون الفعلي سيأتي من التدرج، ولكن هذا يحدد الشفافية النهائية
          ...
          Text(
            ...
            style: const TextStyle(
              // 🌟 استخدام لون النص الفاتح (الرمادي الداكن) للثيم الداكن
...
// =========================================================================
// 3. كود SettingRow (مُحدَّث ليناسب الخلفية الداكنة)
// =========================================================================
...
// =========================================================================
// 4. كود الصفحة الرئيسية (SettingsView) - تطبيق الثيم الداكن
// =========================================================================
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // 🌟🌟 إضافة خلايا المعلومات (TitleSubtitleCell) هنا
            Padding(
